			...
			public void actionPerformed(ActionEvent e) {
				if (check()) {
					...
					if (isSuccess) {
						...
						JOptionPane.showMessageDialog(null, AppConstants.ERROR_NOT_EXIST_MASSAGE, AppConstants.UPDATE_ERROR_TITLE,JOptionPane.WARNING_MESSAGE);  
				}
				else
					JOptionPane.showMessageDialog(null, AppConstants.ERROR_NULL_MASSAGE, AppConstants.UPDATE_ERROR_TITLE,JOptionPane.WARNING_MESSAGE);
			}
		});
