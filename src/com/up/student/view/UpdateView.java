...
//					else
//						JOptionPane.showMessageDialog(null, AppConstants.UPDATE_ERROR_EXIST_MASSAGE, AppConstants.UPDATE_ERROR_TITLE,JOptionPane.WARNING_MESSAGE);  
				}
				else
					JOptionPane.showMessageDialog(null, AppConstants.UPDATE_ERROR_NULL_MASSAGE, AppConstants.UPDATE_ERROR_TITLE,JOptionPane.WARNING_MESSAGE);
			}
		});
